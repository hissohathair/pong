...
function Player:automove(paddle_speed, ball_x, ball_y)
	if self.playerNumber == 1 then
		return self:automove1(paddle_speed, ball_x, ball_y)
	else
		return self:automove2(paddle_speed, ball_x, ball_y)
	end
	return 0
end

function Player:automove1(paddle_speed, ball_x, ball_y)
...
function Player:automove2(paddle_speed, ball_x, ball_y)
